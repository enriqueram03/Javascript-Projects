...
const Calculator = { 
    ...
    Display_Value: '0' 
    // this will nold the first operand for any expressions, we set to noll for now 
    First_Operand: null, 
    //this checks whether or not the second operand has been input 
    Wait_Second_Operand : false, 
    //will hold the operator , we set it to null for now 
    operator: null,
  };
...
function Handle_Operator(Next_Operator) {
  ...
  keys.addEventListener('click', (event) => {
    ...
    // ensures that the AC clears the numbers from the calculator
